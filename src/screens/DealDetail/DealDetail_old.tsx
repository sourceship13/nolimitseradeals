...
const DealDetailScreen: React.FC<DealDetailProps> = (props) => {
  ...
  // Get heart status from pre-loaded data in useAuth context
  ...
  }, [initialDeal, isSaved, heartedDeals]);
