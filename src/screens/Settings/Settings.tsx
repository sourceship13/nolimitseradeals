  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        <View style={styles.section}>
          <View style={styles.row}>
            ...
            <TouchableOpacity
              ...
              style={{ padding: 4 }}
            >
              <Text style={[iOSUIKit.subhead, { color: colors.primary }]}>
                🔄 Refresh
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Switch
              ...
              onValueChange={value =>
                setNotifications({ ...notifications, expiry: value })
              }
            />
          </View>
          <View style={styles.row}>
            ...
            <Switch
              value={notifications.referrals}
              onValueChange={value =>
                setNotifications({ ...notifications, referrals: value })
              }
            />
          </View>
        </View>
        ...
        >
          <Text
            style={[iOSUIKit.callout, { color: '#fff', fontWeight: 'bold' }]}
          >
            Sign Out
          </Text>
        </TouchableOpacity>
